...
/**
 * Represents an engineering team in the developer portal.
 */
@Entity
@Table(name = "teams",
...
public class Team {
    ...
    @SequenceGenerator(name = "teams_gen", sequenceName = "teams_seq", allocationSize = 50)
    private Long id;
    ...
    @Column(name = "email_distribution", length = 255)
